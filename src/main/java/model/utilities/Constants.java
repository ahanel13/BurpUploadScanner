...
public class Constants {
  ...
  public static final String[][] IM_MVG_TYPES = {
      {"", "", ""}, {"", ORIGINAL_FILE_EXTENSION, ""}, {"", "", "image/png"},
  ...
  public static final String[][] XBM_TYPES = {
      {"", "", ""}, {"", ORIGINAL_FILE_EXTENSION, ""}, {"", ".xbm", ""},
      {"", ".xbm", "image/x-xbm"}, {"", ".xbm", "image/png"}, {"xbm:", ORIGINAL_FILE_EXTENSION, ""},
  };

  public static final String[][] GHOSTSCRIPT_TYPES = {
      {"", ORIGINAL_FILE_EXTENSION, ""}, {"", ".gs", ""}, {"", ".eps", ""},
      {"", ORIGINAL_FILE_EXTENSION, "text/plain"}, {"", ".jpeg", "image/jpeg"},
      {"", ".png", "image/png"},
  };

  public static final String[][] LIB_AV_FORMAT_TYPES = {
      // {"", "", ""},
      {"", ORIGINAL_FILE_EXTENSION, ""}, {"", ORIGINAL_FILE_EXTENSION, "audio/mpegurl"},
  ...
  public static final String[][] EICAR_TYPES = {
      // {"", "", ""},
      {"", ORIGINAL_FILE_EXTENSION, ""}, {"", ".exe", ""}, {"", ".exe", "application/x-msdownload"},
      ...
      {"", ORIGINAL_FILE_EXTENSION, ""}, {"", ORIGINAL_FILE_EXTENSION, "application/x-msdownload"},
  ...
  public static final String[][] PL_TYPES = {
      ...
      {"", ORIGINAL_FILE_EXTENSION, "text/x-perl-script"}, {"", ".pl", ""},
  ...
  public static final String[][] PY_TYPES = {
      // {"", ORIGINAL_FILE_EXTENSION, ""},
      {"", ORIGINAL_FILE_EXTENSION, "text/x-python-script"}, {"", ".py", ""},
      {"", ".py", "text/x-python-script"}, {"", ".cgi", ""}
  };

  public static final String[][] RB_TYPES = {
      // {"", ORIGINAL_FILE_EXTENSION, ""},
      {"", ORIGINAL_FILE_EXTENSION, "text/x-ruby-script"}, {"", ".rb", ""},
  ...
  public static final String[][] PDF_TYPES = {
      {"", ORIGINAL_FILE_EXTENSION, ""}, {"", ORIGINAL_FILE_EXTENSION, "application/pdf"},
  ...
  public static final String[][] ZIP_TYPES = {
      {"", ORIGINAL_FILE_EXTENSION, ""}, {"", ORIGINAL_FILE_EXTENSION, "application/zip"},
      {"", ".zip", ""}, {"", ".zip", "application/zip"},
  };

  public static final String[][] CSV_TYPES = {
      // {"", "", ""},
      {"", ORIGINAL_FILE_EXTENSION, ""}, {"", ".csv", ""}, {"", ".csv", "text/csv"},
  ...
  public static final String[][] EXCEL_TYPES = {
      // {"", "", ""},
      {"", ORIGINAL_FILE_EXTENSION, ""}, {"", ".xls", ""}, {"", ".xls", "application/vnd.ms-excel"}
      // {"", ORIGINAL_FILE_EXTENSION, ""},
      // {"", ORIGINAL_FILE_EXTENSION, "text/application/vnd.ms-excel"},
  };

  public static final String[][] IQY_TYPES = {
      {"", ORIGINAL_FILE_EXTENSION, ""}, {"", ".iqy", ""}, {"", ".iqy", "application/vnd.ms-excel"},
  };
...
// It is unlikely that a server accepts content type text/html...
  ...
  public static final String[][] XML_TYPES = {
      {"", ORIGINAL_FILE_EXTENSION, ""}, {"", ".xml", "application/xml"}, {"", ".xml", "text/xml"},
      // {"", ".xml", "text/plain"},
      {"", ".xml", ""}, {"", ORIGINAL_FILE_EXTENSION, "text/xml"},
  };

  public static final String[][] SWF_TYPES = {
      {"", ORIGINAL_FILE_EXTENSION, ""}, {"", ".swf", "application/x-shockwave-flash"},
      {"", ".swf", ""}, {"", ORIGINAL_FILE_EXTENSION, "application/x-shockwave-flash"},
  };

  public static final String[][] HTML_TYPES = {
      {"", ORIGINAL_FILE_EXTENSION, ""}, {"", ".htm", ""}, {"", ".html", ""},
      {"", ".htm", "text/html"},
      // {"", ".html", "text/html"},
