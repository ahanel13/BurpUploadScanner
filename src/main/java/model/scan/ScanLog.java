...
public void addLog(
  ...
  CheckHistory history  = new CheckHistory(fileName, fileHash, uploadRequest, preflightRequest, downloadRequest);
...
private record CheckHistory(
    ...
    HttpRequestResponse uploadRequest, HttpRequestResponse preFlightRequest,
