...
public class DefaultConfigTab extends JPanel {
  ...
  public AbstractButton getReplaceFileSize()    { return _baseConfigTemplate.getReplaceFileName(); }
  ...
  public void setReplaceFileName(boolean b)            {  _baseConfigTemplate.setReplaceFileSize(b); }
